            ...
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-6">
                            ...
                            {results.map((option, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-end mb-2 z-10 relative">
                                        ...
                                        <span className="font-mono font-bold text-2xl text-gray-900 dark:text-white tabular-nums">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {/* Voter Feed */}
                        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden flex flex-col max-h-[600px]">
