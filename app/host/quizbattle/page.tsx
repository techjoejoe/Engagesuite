...
function MyGamesContent() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 text-gray-600 dark:text-gray-300">
                Loading...
            </div>
        );
    }
    ...
    return (
        <main className="min-h-screen bg-gray-50 dark:bg-slate-900 p-6 font-sans transition-colors duration-300">
                ...
                <div className="grid gap-4">
                    {quizzes.map((quiz) => (
                        <div key={quiz.id}
                            ...
                            className="bg-white dark:bg-slate-800 rounded-2xl p-6 flex items-center shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-slate-700 group"
                        >
                            {/* Icon */}
                            ...
                            <div className="flex items-center gap-3" onClick={(e) => e.stopPropagation()}>
                                <button
                                    ...
                                    className="w-10 h-10 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-500 dark:text-gray-400 flex items-center justify-center transition-all hover:border-blue-500 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                                    title="Clone Game"
                                >
                                ...
                                <button
                                    ...
                                    className="w-10 h-10 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-500 dark:text-gray-400 flex items-center justify-center transition-all hover:border-red-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"
                                    title="Delete Game"
                                >
