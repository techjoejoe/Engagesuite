...
export default async function getCroppedImg(
    ...
    // Resize to a reasonable size (e.g. 256x256) for profile photos
    const MAX_SIZE = 256;
    ...
    // Draw the cropped image onto the final resized canvas
    // We need to draw the original canvas onto the new one
